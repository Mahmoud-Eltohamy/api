...
RUN pip install --no-cache-dir robotframework robotframework-extendedrequestslibrary robotframework-faker \
    ...
    robotframework-requests robotframework-jsonschemalibrary robotframework-databaselibrary RESTinstance robotframework-pabot markdown PyMySQL robotframework-mongodb-library asyncio aiohttp
